...
(function() {
    ...
    var ourTwitchAdSolutionsVersion = 8;// Only bump this when there's a breaking change to Twitch, the script, or there's a conflict with an unmaintained extension which uses this script
